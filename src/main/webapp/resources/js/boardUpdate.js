...
function addFields() {
    ...
    newFileInput.name = "newfile" + fieldCount;
    ...
    newTitleInput.name = "newtitle" + fieldCount;
    ...
    newLocationInput.name = "newlocation" + fieldCount;
    ...
    newTextArea.name = "newcontent" + fieldCount;
    ...
    newTagInput.name = "newtag" + fieldCount;
    ...
    document.getElementById("nfc").value = fieldCount;
    fieldCount++;
}